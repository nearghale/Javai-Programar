...
public class frag_prog_basico_grupo_2 extends Fragment implements Interface_menu {
    ...
    public frag_prog_basico_grupo_2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_prog_basico_grupo_2, container, false);
        // linkar com o componente da view


        aula01 = (Button) view.findViewById(R.id.basico_instrucoes_controle_parte_2);
        aula02 = (Button) view.findViewById(R.id.basico_metodos_analise_aprofundada);
        aula03 = (Button) view.findViewById(R.id.basico_array_arraylist);
        aula04 = (Button) view.findViewById(R.id.basico_classes_objetos_analise_aprofundada);

        home = (TextView) view.findViewById(R.id.home_basico_grupo_2);


        btn_prev = (ImageView) view.findViewById(R.id.basico_btn_prev_grupo_2);
        btn_next = (ImageView) view.findViewById(R.id.basico_btn_next_grupo_2);
        ...
        constraintLayout = (ConstraintLayout) view.findViewById(R.id.frag_basico_grupo_2_constraint);
